...
if __name__ == "__main__":
    ...
    os.makedirs(f"results/raw/fig9", exist_ok=True)
    out.to_csv(f"results/raw/fig9/K{args.K}_trial{args.trial}.csv",
               index=False)
    ...
    os.makedirs(f"results/raw/fig9/pvals", exist_ok=True)
    df.to_csv(f"results/raw/fig9/pvals/K{args.K}_trial{args.trial}.csv",)
