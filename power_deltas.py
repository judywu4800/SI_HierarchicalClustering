...
if __name__ == "__main__":
    ...
    power_results, recovery_results, success_results = check_power_multi_tau_delta(
        n, p, sigma, tau_list, delta_list, alpha, num_trials, n_jobs
    )
    ...
    for tau in tau_list:
        ...
        plt.plot(delta_list, [power_results[tau][d] for d in delta_list],
