...
if __name__ == "__main__":
    ...
    run_gao_type1_parallel = ro.r['run_gao_type1_parallel']

    print("Running Gao Type I Error simulation in R (parallel)...")
    ...
    output_file = os.path.join(output_dir, "type1_gao.csv")
