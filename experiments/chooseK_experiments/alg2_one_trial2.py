...
if __name__ == "__main__":
    ...
    #X, labels = generate_3cluster_data_varsize(n=n, delta=args.delta)
    ...
    os.makedirs(f"results/k_hat_raw_{n}", exist_ok=True)
    out.to_csv(f"results/k_hat_raw_{n}/delta{args.delta}_trial{args.trial}.csv",
               index=False)
    ...
    os.makedirs(f"results/k_hat_raw_{n}/pvals", exist_ok=True)
    df.to_csv(f"results/k_hat_raw_{n}/pvals/{args.delta}_trial{args.trial}.csv",)
