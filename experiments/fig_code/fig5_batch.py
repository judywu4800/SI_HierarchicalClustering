...
def run_randomized_pvals(n, p, sigma, K, tau, linkage, num_trials=1000, n_jobs=-1):
    ...
    output_dir = os.path.join(base_dir, "results/raw/fig5_batch")
...
if __name__ == "__main__":
    ...
    if args.method == "randomized":
        run_randomized_pvals(n, p, sigma, args.K, args.tau, args.linkage,
                             num_trials=args.num_trials, n_jobs=args.n_jobs)
    else:
